...
require("aravindan.comment")
require("aravindan.gitsigns")
require("aravindan.nvimtree")
require("aravindan.bufferline")
require("aravindan.toggleterm")
require("aravindan.indentline")
require("aravindan.alpha")
